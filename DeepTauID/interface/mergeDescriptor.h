...
#ifndef DEEPTAU_DEEPTAUID_INTERFACE_MERGEDESCRIPTOR_H_
#define DEEPTAU_DEEPTAUID_INTERFACE_MERGEDESCRIPTOR_H_
...
#endif /* DEEPTAU_DEEPTAUID_INTERFACE_MERGEDESCRIPTOR_H_ */
